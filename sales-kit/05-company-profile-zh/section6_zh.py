# -*- coding: utf-8 -*-
# 简体中文版 — Chinese Simplified Translation
"""
Section 6: Awards, Strategic Vision, Lifetime Support, Project Notes \& Back Cover (Pages 31 - 36)
"""

PAGE_31 = r"""% ============================================================
% 第 31: BẰNG KHEN, GIẢI THƯỞNG \& CHỨNG NHẬN 能力简介 [第 MỚI]
% ============================================================
\pageheaderbar{BẰNG KHEN \& CHỨNG NHẬN 能力简介}{第31页}
\pagefooterbar{第31页}
...
\begin{tabular}{@{}p{91mm}@{\hspace{4mm}}p{91mm}@{}}
  ...
  \begin{tikzpicture}
    \node[
      ...
      {\fontsize{8.8}{10.8}\selectfont\bfseries\color{TTCRed} \faAward\quad 1. CHỨNG CHỈ 能力简介 HẠNG I (BỘ XÂY DỰNG):}\\[3pt]
      {\fontsize{7.2}{9.2}\selectfont\color{TTCTextDark}
      \textbullet\ Chứng chỉ năng lực hoạt động xây dựng Hạng I do Cục Quản lý Hoạt động Xây dựng -- Bộ Xây Dựng cấp phép.\newline
      \textbullet\ Bảo chứng thẩm quyền Tổng thầu Thiết kế \& Thi công công trình công nghiệp quy mô không giới hạn diện tích sàn.\newline
      \textbullet\ 资质 vượt nhịp dầm thép lớn $>60$m và nhà máy nhiều tầng.}
    };
  \end{tikzpicture} &
  ...
  \begin{tikzpicture}
    \node[
      ...
      {\fontsize{8.8}{10.8}\selectfont\bfseries\color{TTCGold} \faMedal\quad 4. BẰNG KHEN THÀNH TÍCH 安 TOÀN 零事故:}\\[3pt]
      {\fontsize{7.2}{9.2}\selectfont\color{TTCTextDark}
      ...
      \textbullet\ 资质认证 nhà thầu xanh tuân thủ nghiêm ngặt ESG.}
    };
  \end{tikzpicture}
\end{tabular}
...
\begin{tikzpicture}
  \node[
    ...
    {\fontsize{9}{11}\selectfont\bfseries\color{TTCBlue} \faShield*\quad CAM KẾT BẢO TOÀN 信H PHÁP LÝ VÀ CHẤT LƯỢNG CHO CHỦ ĐẦU TƯ:}\\[3pt]
    \begin{tabularx}{\linewidth}{@{}p{56mm}@{\hspace{4mm}}p{56mm}@{\hspace{4mm}}p{56mm}@{}}
      \textbf{\color{TTCRed}1. Pháp Nhân Minh Bạch:}\newline
      {\fontsize{6.8}{8.5}\selectfont Đầy đủ hồ sơ năng lực pháp lý Hạng I, không vướng tranh chấp kiện tụng, sẵn sàng vượt qua các vòng thẩm định thầu quốc tế.} &
      \textbf{\color{TTCCyan}2. Chứng Chỉ Hành Nghề:}\newline
      {\fontsize{6.8}{8.5}\selectfont 100\% Giám đốc Dự án và Chỉ huy trưởng có Chứng chỉ hành nghề Hạng I phù hợp quy mô công trình.} &
...
\begin{tikzpicture}
  \node[
    ...
    \begin{tabularx}{176mm}{@{}Y|Y|Y|Y@{}}
      {\fontsize{14}{16}\selectfont\bfseries\color{TTCRed} 一级建筑资质} &
      ...
      {\fontsize{14}{16}\selectfont\bfseries\color{TTCGold} >3.5M GIỜ 安 TOÀN} \\
      {\fontsize{7.2}{9}\selectfont Năng Lực Xây Dựng Cấp I} &
...
PAGE_32 = r"""% ============================================================
% 第 32: BẢN ĐỒ 项目 20+ TỈNH THÀNH & 4 CAM KẾT BẢO LÃNH VÀNG
% ============================================================
\pageheaderbar{施工覆盖地图与四大金牌承诺}{第32页}
\pagefooterbar{第32页}
...
\begin{tikzpicture}
  \node[
    ...
    {\fontsize{9}{11}\selectfont\bfseries\color{TTCBlue} \faGem\quad 4 CAM KẾT VÀNG BẤT BIẾN CỦA 新成功 DÀNH CHO KHÁCH HÀNG:}\\[3pt]
    \begin{tabularx}{\linewidth}{@{}p{86mm}@{\hspace{4mm}}p{86mm}@{}}
      \textbf{\color{TTCRed}1. TIẾN ĐỘ THẦN 速 (FAST-TRACK):}\newline
      ...
      \textbf{\color{TTCBlue}3. 零事故 (安 TOÀN TUYỆT ĐỐI):}\newline
      ...
      \textbf{\color{TTCGold}4. BẢO HÀNH 24 THÁNG CẤP 速:}\newline
...
PAGE_33 = r"""% ============================================================
% 第 33: TẦM NHÌN 2026-2030 \& CHIẾN LƯỢC PHÁT TRIỂN [第 MỚI]
% ============================================================
\pageheaderbar{TẦM NHÌN 2026--2030 \& CHIẾN LƯỢC PHÁT TRIỂN}{第33页}
\pagefooterbar{第33页}
...
\begin{tabular}{@{}p{59mm}@{\hspace{3.5mm}}p{59mm}@{\hspace{3.5mm}}p{59mm}@{}}
  ...
  \begin{tikzpicture}
    \node[rounded corners=4pt, fill=white, draw=TTCBlue!40!white, line width=0.8pt, minimum width=59mm, minimum height=95mm, inner sep=4pt, text width=53mm, align=left] {
      ...
      {\fontsize{7}{8.5}\selectfont\bfseries\color{TTCBlue} 突破 CONTECH}\\[3pt]
      {\fontsize{6.8}{8.5}\selectfont\color{TTCTextDark}
      \textbullet\ \textbf{营收 mục tiêu:} 120 Tỷ VNĐ (\$4,9M USD).\newline
  ...
  \begin{tikzpicture}
    \node[rounded corners=4pt, fill=TTCLightBlue, draw=TTCCyan!80!white, line width=0.8pt, minimum width=59mm, minimum height=95mm, inner sep=4pt, text width=53mm, align=left] {
      ...
      {\fontsize{6.8}{8.5}\selectfont\color{TTCTextDark}
      \textbullet\ \textbf{营收 mục tiêu:} 625 Tỷ VNĐ (\$25M USD).\newline
      ...
      \textbullet\ \textbf{Quản Trị Số Hóa:} Vận hành ERP SAP S/4H安A toàn diện.}
    };
  \end{tikzpicture} &
  % Horizon 3: 2029-2030
  \begin{tikzpicture}
    \node[rounded corners=4pt, fill=white, draw=TTCBlue!40!white, line width=0.8pt, minimum width=59mm, minimum height=95mm, inner sep=4pt, text width=53mm, align=left] {
      ...
      {\fontsize{6.8}{8.5}\selectfont\color{TTCTextDark}
      \textbullet\ \textbf{营收 mục tiêu:} 1.000 Tỷ VNĐ (\$40M USD).\newline
...
PAGE_34 = r"""% ============================================================
% 第 34: 能力简介 BẢO HÀNH \& DỊCH VỤ VÒNG ĐỜI 30+ NĂM [第 MỚI]
% ============================================================
\pageheaderbar{BẢO HÀNH \& DỊCH VỤ VÒNG ĐỜI 30+ NĂM}{第34页}
\pagefooterbar{第34页}

\begin{tikzpicture}[remember picture, overlay]
  \node[opacity=0.03, scale=2.8, font=\bfseries\sffamily, text=TTCBlue] at ([yshift=-10mm]current page.center) {COMPREHENSIVE WARR安TY \& 30-YEAR LIFECYCLE O\&M};
  \draw[TTCBlue!6!white, line width=0.5pt] ([xshift=15mm, yshift=20mm]current page.south west) grid[step=8mm] ([xshift=195mm, yshift=45mm]current page.south west);
\end{tikzpicture}
...
\begin{tikzpicture}
  \node[
    ...
    {\fontsize{9}{11}\selectfont\bfseries\color{TTCBlue} \faHeadset\quad QUY TRÌNH XỬ LÝ SỰ CỐ BẢO HÀNH CỦA 新成功:}\\[3pt]
    \begin{tabularx}{\linewidth}{@{}p{56mm}@{\hspace{4mm}}p{56mm}@{\hspace{4mm}}p{56mm}@{}}
...
PAGE_35 = r"""% ============================================================
% 第 35: 第 GHI CHÚ \& TRAO ĐỔI 项目 [第 MỚI]
% ============================================================
\pageheaderbar{GHI CHÚ \& TRAO ĐỔI 项目}{第35页}
\pagefooterbar{第35页}
...
% TẦNG 1: BẢNG CHECKLIST NH安H THÔNG TIN 项目
\noindent
\begin{tikzpicture}
  \node[
    rounded corners=6pt,
    ...
    {\fontsize{9}{11}\selectfont\bfseries\color{TTCBlue} \faCheckSquare\quad PHIẾU THÔNG TIN SƠ BỘ NHU CẦU 项目 (PROJECT INTAKE CHECKLIST):}\\[3pt]
...
% TẦNG 2: KHÔNG GI安 DÒNG KẺ GHI CHÚ CHUYÊN NGHIỆP
\noindent
\begin{tikzpicture}
...
% TẦNG 3: B安NER LIÊN HỆ TRỰC TIẾP
\noindent
\begin{tikzpicture}
  \node[
    rounded corners=6pt,
    ...
    \begin{tabularx}{176mm}{@{}p{115mm}X@{}}
      ...
      {\fontsize{7.5}{9.5}\selectfont 总经理: \textbf{+84 976 447 766} \quad\textbullet\quad Email: \textbf{ceo@tanthanhcongjsc.com}} &
      \raggedleft
      {\fontsize{8.5}{10.5}\selectfont\bfseries\color{TTCGold} 新成功 JSC}\newline
...
PAGE_36 = r"""% ============================================================
% 第 36: 第 BÌA SAU (BACK COVER) -- PHÁP NHÂN TOÀN DIỆN \& KẾT NỐI
% ============================================================
\thispagestyle{empty}
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center] at ([yshift=65mm]current page.center) {
    \begin{tikzpicture}
      \node[align=center, text=white] {
        {\fontsize{24}{28}\selectfont\bfseries 新成功 JSC}\\[4pt]
  ...
  \node[anchor=center] at ([yshift=38mm]current page.center) {
    \begin{tikzpicture}
      \node[
        ...
        {\fontsize{10.5}{13}\selectfont\bfseries\color{TTCBlue} ``ĐỒNG HÀNH CÙNG KHÁCH HÀNG KIẾN TẠO NHỮNG TỔ HỢP CÔNG NGHIỆP HIỆN ĐẠI, 安 TOÀN VÀ TRƯỜNG TỒN''}\\[2pt]
    ...
    \begin{tikzpicture}
      \node[
        ...
        \begin{tabularx}{174mm}{@{}Y|Y@{}}
          ...
          {\fontsize{8.5}{10.5}\selectfont\bfseries\color{TTCRed} \faVideo\quad THAM QU安 3D VIRTUAL TOUR NHÀ MÁY}\newline
  ...
  \node[anchor=south, text=white!80!gray, font=\fontsize{7}{8.5}\selectfont] at ([yshift=7mm]current page.south) {
    \textcopyright\ 2026 新成功建筑科技股份公司 \textbullet\ ALL RIGHTS RESERVED \textbullet\ ISO 9001:2015 \textbullet\ CHỨNG CHỈ 能力简介 一级建筑资质
  };
\end{tikzpicture}
"""
