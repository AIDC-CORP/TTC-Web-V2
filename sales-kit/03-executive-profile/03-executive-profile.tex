...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=center,inner sep=0pt] at (current page.center) {
    \includegraphics[width=\paperwidth,height=\paperheight]{d:/AIDC/TTC-V2/TTC-Web-V2/public/executive-cover-hero.jpg}
  };
      ...
      \begin{tabularx}{\linewidth}{@{}l X r@{}}
        ...
        \begin{tikzpicture}[baseline=(logo.center)]
          \node[
            ...
            \includegraphics[height=13mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/logo.png}
          };
        \end{tikzpicture}
        &
        \vspace{1mm}
...
\begin{tabular}{@{}p{91mm}@{\hspace{4mm}}p{91mm}@{}}
  ...
  \begin{tikzpicture}
    \node[rounded corners=6pt, draw=TTCBorder, line width=0.8pt, inner sep=0pt, fill=white] (pimg) {
      \includegraphics[width=91mm,height=55mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/c_level_site_inspection.jpg}
    };
    \node[
...
\begin{tikzpicture}
  \node[
    ...
    \begin{tabularx}{176mm}{@{}Y|Y|Y|Y@{}}
      {\fontsize{15}{17}\selectfont\bfseries\color{TTCRed} 300--500 TỶ} &
...
\begin{tikzpicture}
  \node[
    ...
    \begin{tabularx}{176mm}{@{}Y|Y|Y@{}}
      {\fontsize{16}{18}\selectfont\bfseries\color{TTCRed} 300 -- 500 TỶ} &
      {\fontsize{16}{18}\selectfont\bfseries\color{TTCCyan} 100\%} &
...
\begin{tabular}{@{}p{91mm}@{\hspace{4mm}}p{91mm}@{}}
  \begin{tikzpicture}
    \node[rounded corners=6pt, draw=TTCBorder, line width=0.8pt, inner sep=0pt, fill=white] (img1) {
      \includegraphics[width=91mm,height=50mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/introsection1.jpg}
    };
  ...
  \begin{tikzpicture}
    \node[rounded corners=6pt, draw=TTCBorder, line width=0.8pt, inner sep=0pt, fill=white] (img2) {
      \includegraphics[width=91mm,height=50mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/introsection2.jpg}
    };
...
\begin{tikzpicture}
  \node[
    ...
    \begin{tabularx}{176mm}{@{}Y|Y|Y|Y@{}}
      {\fontsize{14}{16}\selectfont\bfseries\color{TTCRed} >300 TỶ VNĐ} &
...
\begin{tikzpicture}
  \node[
    ...
    \includegraphics[width=186mm,height=55mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/bim-model-3d.jpg}
  };
  \node[
...
\begin{tikzpicture}
  \node[
    ...
    \includegraphics[width=186mm,height=55mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/bim-esg-factory-3d.jpg}
  };
  \node[
    anchor=south, fill=TTCBlue!95!black, draw=TTCCyan!80!white,
    line width=0.6pt, text=white, rounded corners=4pt, inner sep=3.5pt,
...
\begin{tabular}{@{}p{43.5mm}@{\hspace{4mm}}p{43.5mm}@{\hspace{4mm}}p{43.5mm}@{\hspace{4mm}}p{43.5mm}@{}}
  \begin{tikzpicture}
    \node[rounded corners=4pt, draw=TTCBorder, line width=0.7pt, inner sep=0pt, fill=white] (p1) {
      \includegraphics[width=43.5mm,height=28mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/project-assets/hongtrang.jpg}
    };
  ...
  \begin{tikzpicture}
    \node[rounded corners=4pt, draw=TTCBorder, line width=0.7pt, inner sep=0pt, fill=white] (p2) {
      \includegraphics[width=43.5mm,height=28mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/project-assets/songhong7.jpg}
    };
  ...
  \begin{tikzpicture}
    \node[rounded corners=4pt, draw=TTCBorder, line width=0.7pt, inner sep=0pt, fill=white] (p3) {
      \includegraphics[width=43.5mm,height=28mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/project-assets/japfa.jpg}
    };
  ...
  \begin{tikzpicture}
    \node[rounded corners=4pt, draw=TTCBorder, line width=0.7pt, inner sep=0pt, fill=white] (p4) {
      \includegraphics[width=43.5mm,height=28mm]{d:/AIDC/TTC-V2/TTC-Web-V2/public/project-assets/daeyun.jpg}
    };
