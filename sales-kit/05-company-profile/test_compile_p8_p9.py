...
PREAMBLE_TEST = r"""% !TEX program = xelatex
...
with open("test_p8_p9.tex", "w", encoding="utf-8") as f:
    f.write(PREAMBLE_TEST)
    f.write(PAGE_08_TEST.strip() + "\n\n")
    f.write(PAGE_09_TEST.strip() + "\n\n")
    f.write(POSTAMBLE_TEST)

print("test_p8_p9.tex generated.")
res = subprocess.run(["xelatex", "-interaction=nonstopmode", "test_p8_p9.tex"], capture_output=True, text=True)
print("Compile return code:", res.returncode)
if res.returncode != 0:
    print("LOG:\n", res.stdout[-1500:])
else:
    print("Success! Converting to PNG...")
    subprocess.run(["pdftoppm", "-png", "-r", "150", "test_p8_p9.pdf", "preview_test_p8_p9"])
    print("PNG generated.")
