      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
        ...
        >
          ...
          <div className="pt-6 text-center">
            <h3 className="text-3xl md:text-4xl font-bold text-blue-700 mb-6 group-hover:text-blue-800 transition-colors duration-300">{t('about.cards.mission.title')}</h3>
            <p className="text-gray-700 text-base md:text-lg font-medium leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
              {t('about.cards.mission.description')}
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pt-6 text-center">
            <h3 className="text-3xl md:text-4xl font-bold text-purple-700 mb-6 group-hover:text-purple-800 transition-colors duration-300">{t('about.cards.vision.title')}</h3>
            <p className="text-gray-700 text-base md:text-lg font-medium leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
              {t('about.cards.vision.description')}
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pt-6 text-center">
            <h3 className="text-3xl md:text-4xl font-bold text-green-700 mb-6 group-hover:text-green-800 transition-colors duration-300">{t('about.cards.core_values.title')}</h3>
            <p className="text-gray-700 text-base md:text-lg font-medium leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
              {t('about.cards.core_values.description')}
            </p>
          </div>
        </motion.div>
      </div>
