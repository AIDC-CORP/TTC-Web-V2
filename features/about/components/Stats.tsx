    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="text-lg font-semibold text-gray-700">{t('about.stats.architects')}</div>
        </motion.div>
        <motion.div
          className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
          variants={statVariants}
        ...
        >
          ...
          <div className="text-lg font-semibold text-gray-700">{t('about.stats.engineers')}</div>
        </motion.div>
        <motion.div
          className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
          variants={statVariants}
        ...
        >
          ...
          <div className="text-lg font-semibold text-gray-700">{t('about.stats.consultants')}</div>
        </motion.div>
        <motion.div
          className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
          variants={statVariants}
        ...
        >
          ...
          <div className="text-lg font-semibold text-gray-700">{t('about.stats.projects')}</div>
        </motion.div>
        <motion.div
          className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
          variants={statVariants}
        ...
        >
          ...
          <div className="text-lg font-semibold text-gray-700">{t('about.stats.staff')}</div>
        </motion.div>
        <motion.div
          className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
          variants={statVariants}
        ...
        >
          ...
          <div className="text-lg font-semibold text-gray-700">{t('about.stats.clients')}</div>
        </motion.div>
      </motion.div>
    </>
  );
