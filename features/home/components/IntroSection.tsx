        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-bold text-gray-900 text-base md:text-lg">{t('home.intro.feature1.title')}</div>
                <p className="text-gray-600 text-base leading-relaxed">
                  {t('home.intro.feature1.description')}
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-red-100 text-red-600">✓</span>
              <div>
                <div className="font-bold text-gray-900 text-base md:text-lg">{t('home.intro.feature2.title')}</div>
                <p className="text-gray-600 text-base leading-relaxed">
                  {t('home.intro.feature2.description')}
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 sm:col-span-2">
              <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-red-100 text-red-600">✓</span>
              <div>
                <div className="font-bold text-gray-900 text-base md:text-lg">{t('home.intro.feature3.title')}</div>
                <p className="text-gray-600 text-base leading-relaxed">
                  {t('home.intro.feature3.description')}
                </p>
              </div>
            </div>
          </div>
