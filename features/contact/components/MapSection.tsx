...
const MapSection: React.FC = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">{t('contactPage.map.title')}</h2>
      <ul className="space-y-4 text-gray-700 text-lg">
        <li className="flex items-start">
          <span className="mt-1 mr-3 text-blue-600">&#x1f4cd;</span>
          <div>
            <h3 className="font-semibold">{t('contactPage.map.address')}</h3>
            <p>{t('contactPage.map.addressValue')}</p>
          </div>
        </li>
        <li className="flex items-start">
          <span className="mt-1 mr-3 text-blue-600">&#x260e;</span>
          <div>
            <h3 className="font-semibold">{t('contactPage.map.hotline')}</h3>
        ...
        <li className="flex items-start">
          <span className="mt-1 mr-3 text-blue-600">&#x2709;</span>
          <div>
            <h3 className="font-semibold">{t('contactPage.map.email')}</h3>
